...
@section('description', 'User Managements')
@section('breadcrumbs')
	@php echo \Breadcrumbs::render(['User Managements']) @endphp
@endsection
@section('button')
	<a href="{{ url('/admin/user/create') }}" class="btn btn-primary btn-xs no-border">Add Data</a>
@endsection
...
@section('content')
    ...
    <table class="table table-hover" id="user-table">
        <thead>
            <tr>
                <th>Unique Number</th><th>Name</th><th>Role</th><th>Status</th>
